"""add semester_study_form table, refactor constraints

Revision ID: 1759eda93d78
Revises: 0c6cf4bf39c4
Create Date: 2025-08-12 15:19:03.900791
...
revision: str = '1759eda93d78'
down_revision: Union[str, None] = '0c6cf4bf39c4'
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_group_semester_group_id'), table_name='group_semester')
    op.drop_index(op.f('ix_group_semester_semester_id'), table_name='group_semester')
...
def downgrade() -> None:
    ...
    op.create_index(op.f('ix_group_semester_semester_id'), 'group_semester', ['semester_id'], unique=False)
    op.create_index(op.f('ix_group_semester_group_id'), 'group_semester', ['group_id'], unique=False)
